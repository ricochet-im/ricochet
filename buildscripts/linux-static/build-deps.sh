...
:$' Order of commands that has worked
cd ${ROOT_SRC}/openssl
git checkout e216bf9d7ca761718f34e8b3094fcb32c7a143e4
export OPENSSL_DIR="${ROOT_LIB}/openssl"
rm -rf ../../lib/openssl
git clean -dfx .
git reset --hard
...
:$' What about the same thing but with a newer openssl -> NOPE
cd ${ROOT_SRC}/openssl
git checkout master
export OPENSSL_DIR="${ROOT_LIB}/openssl"
rm -rf ../../lib/openssl
...
:$' What about the same thing but with a newer tor
cd ${ROOT_SRC}/openssl
git checkout e216bf9d7ca761718f34e8b3094fcb32c7a143e4
export OPENSSL_DIR="${ROOT_LIB}/openssl"
rm -rf ../../lib/openssl
